...
public:
    ...
    static bool storeItemIn(ItemInfo *item, Enums::ItemStorage::ItemStorageEnum storage, quint8 rowsTotal, quint32 plugyPage = 0, quint8 colsTotal = 10, bool shouldChangeCoordinatesBits = true);
    static bool storeItemIn(ItemInfo *item, Enums::ItemStorage::ItemStorageEnum storage, quint8 rowsTotal, Enums::ItemLocation::ItemLocationEnum location, ItemsList *pItems = 0, quint32 plugyPage = 0, quint8 colsTotal = 10, bool shouldChangeCoordinatesBits = true);
